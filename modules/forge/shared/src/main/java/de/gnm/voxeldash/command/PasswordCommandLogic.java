...
/**
 * Version-independent business logic for {@code /voxeldash password <password>}.
 * The per-line command shells (Brigadier on 1.16+, CommandBase on 1.12/1.8) only
 * extract the player/op-state/password from their version-specific command API and
 * hand off here; replies go back through the {@code reply} consumer.
 */
