...
public class ForgeWidgetProvider {
    ...
    public void register() {
        ...
        registry.registerWidget(new Widget(
                ...
                () -> {
                    ...
                    stats.put("value", ForgeUtil.compat().onlinePlayerCount());
                    stats.put("max", ForgeUtil.compat().maxPlayers());
                    return stats;
                }
        ));
    ...
    /**
     * Current server TPS (via the version seam)
     */
    private double getCurrentTps() {
        return ForgeUtil.compat().currentTps();
    }
}
